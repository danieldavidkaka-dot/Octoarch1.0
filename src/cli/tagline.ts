const DEFAULT_TAGLINE = "All your chats, one Octoarch.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little octo-sistant is here to ship joy, roll back chaos, and stash the keys safely.",
  ...
  hanukkah:
    "Hanukkah: Eight nights, eight arms, zero shame—may your gateway stay lit and your deployments stay peaceful.",
  halloween:
...
const TAGLINES: string[] = [
  "Your terminal just grew tentacles—type something and let the bot handle the busywork.",
  ...
  "Gateway online—please keep hands, feet, and tentacles inside the shell at all times.",
  ...
  "Automation with reach: minimal fuss, maximal efficiency.",
  "I'm basically a Swiss Army knife, but with eight arms and fewer sharp edges.",
  ...
  "Tentacles out, commit in—let's ship something mildly responsible.",
  "I'll juggle your workflow like I have eight hands: messy, chaotic, effective.",
  "Ink yeah—I'm here to wrap up the toil and leave you the glory.",
  ...
  "The only cephalopod in your contacts you actually want to hear from. 🐙",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.OCTOARCH_TAGLINE_INDEX;
